from PySide6.QtWidgets import QWidget, QVBoxLayout, QHBoxLayout, QLineEdit, QPushButton, QLabel, QApplication, QFileDialog, QCheckBox, QMessageBox, QTextBrowser, QGridLayout, QSizePolicy, QComboBox
...
class MorseCodeCom(QWidget):
    ...
    def analyze_in_mode(self, audio_file_path, mode):
        ...
        if mode == 0:
            ...
            audioAnalyzer.analyze(audio_file_path, low_freq=980, high_freq=1020, amplitude_threshold=9.0, dot_threshold=0.03,
                                  dash_threshold=0.14, char_gap_threshold=0.08)
        elif mode == 2:
            audioAnalyzer.analyze(audio_file_path, low_freq=770, high_freq=825, amplitude_threshold=12.0, dot_threshold=0.03,
                                  dash_threshold=0.14, char_gap_threshold=0.08)
...
class DecrypterCom(QWidget):
    ...
    def update_text_display_match(self, mode):
        processed_text = self.text_display.text()
        if mode == 5:
